...
const data2 = [
  { name: '11/20', '강수량(mm)': 0.0 },
  { name: '11/21', '강수량(mm)': 0.0 },
  { name: '11/22', '강수량(mm)': 1.0 },
  { name: '11/23', '강수량(mm)': 0.2 },
  { name: '11/24', '강수량(mm)': 0.0 },
  { name: '11/25', '강수량(mm)': 1.0 },
  { name: '11/26', '강수량(mm)': 0.2 },
  { name: '11/27', '강수량(mm)': 0.3 },
];
const data3 = [
  { name: '21년 1분기', '수확량(개)': 78 },
  { name: '21년 2분기', '수확량(개)': 190 },
  { name: '21년 3분기', '수확량(개)': 208 },
  { name: '22년 4분기', '수확량(개)': 215 },
];
const data4 = [
  { name: '21년 1분기', '수입(만원)': 30.24 },
  { name: '21년 2분기', '수입(만원)': 73.2 },
  { name: '21년 3분기', '수입(만원)': 86.3 },
  { name: '22년 4분기', '수입(만원)': 92.12 },
];
const data5 = [
...
const data6 = [
  { name: '10월 4주', '병해충 발생(%)': 3.2 },
  { name: '11월 1주', '병해충 발생(%)': 4.1 },
  { name: '11월 2주', '병해충 발생(%)': 2.2 },
  { name: '11월 3주', '병해충 발생(%)': 1.7 },
  { name: '11월 4주', '병해충 발생(%)': 1.5 },
];
const tasks = [
...
const acts = [
  ...
  { title: '오늘 피곤해서 물을 줬었어야했는데 ㅜㅡㅜ', due: '2021. 11. 13' },
  { title: '계산에서 실수가 났다.', due: '2021. 11. 22' },
  { title: '이번 분기에 이익이 많이 났다', due: '2021. 11. 25' },
  { title: '성장률이 높은 걸 보니 기분이 좋다.', due: '2021. 11. 26' },
];
